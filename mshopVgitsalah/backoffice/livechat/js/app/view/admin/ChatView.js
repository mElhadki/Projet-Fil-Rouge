...
(function(app, $, config, _)
{
    var ChatView = app.ChatView = Backbone.View.extend({
        ...
        selectCannedMessage : function()
        {
            ...
            app.view.dialogs.confirm(app.service.i18n.trans('select.msg'), view, {
        ...
        _setInputPadding : function()
        {
            ...
            {
                this.$input.css('padding-left', this.inputPadding);
            }
            else
            {
                setTimeout($.proxy(function()
                {
                    ...
                    this.inputPadding = this.$('.btn-canned-msg').outerWidth() + 8;
