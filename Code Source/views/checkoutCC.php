...
include(ROOT_PATH .'/app/controllers/stripe.php');
...
<body>
  ...
  <div id="container" class="container">
    ...
    <div class="row">
      ...
      <div class="col-md-8 order-md-1" style="    height: 800px;">
     
        <h4 class="mb-3">Billing address</h4>
        <form class="needs-validation" id="payment-form" method="post">
          ...
          <div class="d-block my-3">
            ...
            <div class="custom-control custom-radio">
              <input id="debit" name="stripe" type="radio" class="custom-control-input" checked>
